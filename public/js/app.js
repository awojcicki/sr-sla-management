...
angular.module('srSlaManagement', ['ngResource']);
...
angular.module('srSlaManagement').controller('jobsListController', jobsListController);
...
angular.module('srSlaManagement').component('jobsList', {
...
(function () {
    angular.module('srSlaManagement').service('jobListDataService', jobListDataService);
